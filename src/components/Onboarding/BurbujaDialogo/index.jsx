export default function BurbujaDialogo({ texto }) {
  return (
    <div className="relative w-full lg:w-[700px]">
      <div className="bg-neutral-white border border-action rounded-[20px] px-4 h-[152px] flex items-center justify-center z-20">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -bottom-[8px] w-0 h-0 border-l-[9px] border-l-transparent border-r-[9px] border-r-transparent border-t-[10px] border-t-neutral-white" />
    </div>
  )
}
