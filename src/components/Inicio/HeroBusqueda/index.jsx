...
export default function HeroBusqueda({ query, onChange, onSubmit, onClear }) {
    return (
        <section className="rounded-[30px] bg-identity px-6 py-4 text-neutral-white">
            <div className="flex flex-col items-center gap-3 text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-base text-identity">
                    <Search size={22} strokeWidth={2.2} />
                </div>
                <div className="space-y-2">
                    <h2 className="text-heading-l text-neutral-white">
                        ¿Dónde es tu clase?
                    </h2>
                    <p className="text-body-s text-neutral-white">
