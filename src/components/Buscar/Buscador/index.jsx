  ...
  return (
    <div className="bg-identity px-4 py-7">
      <div className="bg-base flex items-center h-10 pl-6 pr-4 rounded-full w-full">
        <Search size={12} className="text-neutral-extra-dark flex-shrink-0" />
        <input
          type="text"
          value={query}
          onChange={(e) => onChange(e.target.value)}
          placeholder="Buscar..."
          className="bg-transparent flex-1 font-saira text-neutral-extra-dark placeholder:text-neutral-main outline-none ml-3"
        />
        {buscando && (
